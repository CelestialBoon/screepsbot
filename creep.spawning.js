...
var creepScheduler = {
    run: function() {
        ...
        //if((Game.time+250)%1500 == 0) { roomList[0].pushStack('upgrader0'); }
        if((Game.time+256)%6000 == 0) { roomList[0].pushStack('builder'); }
        if((Game.time+50)%480 == 0) { roomList[0].pushStack('oldupgrader'); }
        if((Game.time-800)%1490 == 0) { roomList[0].pushStack('miner0'); }
        if((Game.time)%1200 == 0) { roomList[0].pushStack('hauler'); }
        ...
        */
        ...
        if((Game.time+234)%750 == 0) { roomList[1].pushStack('upgrader1'); }
        //if((Game.time+300)%6000 == 0) { roomList[1].pushStack('harvester10'); }
        //if((Game.time+3300)%6000 == 0) { roomList[1].pushStack('harvester11'); }
        if((Game.time)%1300 == 0) { roomList[1].pushStack('hauler'); }
    
        //if((Game.time+150)%1500 == 0) { roomList[1].pushStack('upgrader1bis'); }
        
        
        
        if((Game.time+100)%1000 == 0) { roomList[2].pushStack('hauler'); }
        if((Game.time+200)%6000 == 0) { roomList[2].pushStack('builder'); }
        if((Game.time+120)%1470 == 0) { roomList[2].pushStack('miner20'); }
        if((Game.time+1140)%1470 == 0) { roomList[2].pushStack('miner21'); }
        if((Game.time+272)%1500 == 0) { roomList[2].pushStack('upgrader2'); }
        //if((Game.time+500)%1000 == 0) { roomList[2].pushStack('harvester21'); }
        if((Game.time+550)%1500 == 0) { roomList[2].pushStack('harvester20'); }
